...
class Trainer(object):
    ...
    def valid_epoch(self,data, data_type = None):
    ...
    def train_epoch(self,data, data_type = None):
    ...
    def train(self,train_data,valid_data, data_type = None):
...
#             break
        ...
        for epoch in range(self.start_epoch,self.start_epoch+self.args.epochs):
            ...
            train_log = self.train_epoch(train_data, data_type)
            valid_log = self.valid_epoch(valid_data, data_type)
